...
public class DesireAvoidSpecific extends DesireBase
{
	...
	public boolean shouldExecute()
	{
        ...
        Vec3D var2 = com.vartala.soulofw0lf.rpgapi.entityapi.nms.RandomPositionGenerator.b(this.getEntityHandle(), 16, 7, Vec3D.a.create(this.m_closestEntity.locX, this.m_closestEntity.locY, this.m_closestEntity.locZ));
