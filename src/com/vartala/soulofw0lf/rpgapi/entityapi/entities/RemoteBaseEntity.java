...
import com.vartala.soulofw0lf.rpgapi.entityapi.api.events.*;
import com.vartala.soulofw0lf.rpgapi.entityapi.api.features.*;
...
import com.vartala.soulofw0lf.rpgapi.entityapi.utilities.*;
...
public abstract class RemoteBaseEntity<T extends LivingEntity> implements RemoteEntity
{
	...
	public void spawn(Location inLocation)
	{
		...
		try
		{
			...
			this.m_entity = (EntityInsentient)this.m_type.getEntityClass().getConstructor(World.class, com.vartala.soulofw0lf.rpgapi.entityapi.api.RemoteEntity.class).newInstance(worldServer, this);
